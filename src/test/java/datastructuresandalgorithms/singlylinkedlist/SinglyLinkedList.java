...
public class SinglyLinkedList {
    ...
    public int[] nextGreaterNode() {
        ...
        while (!stack1.isEmpty()) {
            while (stack2.size() > 0 && stack2.peek() <= stack1.peek()) {
                stack2.pop();
            }
            if (stack2.size() == 0) {
                result[i] = 0;
    ...
    public static void main(String[] args) {
        ...
        singlyLinkedList.addNodeAtGivenPosition(1, 1);
        singlyLinkedList.addNodeAtGivenPosition(2, 4);
        singlyLinkedList.addNodeAtGivenPosition(3, 3);
        singlyLinkedList.addNodeAtGivenPosition(4, 2);
        singlyLinkedList.addNodeAtGivenPosition(5, 5);
        singlyLinkedList.addNodeAtGivenPosition(6, 2);
        singlyLinkedList.display();
        singlyLinkedList.head=singlyLinkedList.partitionList(singlyLinkedList.head, 3);
        singlyLinkedList.display();
      ...
      /*  singlyLinkedList.addNodeAtGivenPosition(1, 2);
        singlyLinkedList.addNodeAtGivenPosition(2, 2);
        singlyLinkedList.addNodeAtGivenPosition(3, 3);
        singlyLinkedList.addNodeAtGivenPosition(4, 3);*/
        ...
        singlyLinkedList.addNodeAtGivenPosition(9, 8);*/
        /*singlyLinkedList.addNodeAtGivenPosition(1, 2);
        singlyLinkedList.addNodeAtGivenPosition(2, 7);
        singlyLinkedList.addNodeAtGivenPosition(3, 4);
        singlyLinkedList.addNodeAtGivenPosition(4, 3);
        singlyLinkedList.addNodeAtGivenPosition(5, 5);*/
        ...
        singlyLinkedList.display();
        singlyLinkedList.mergeSortedList(current, temp);*/
        // singlyLinkedList.reverseBetween(3, 6);
       /* singlyLinkedList.display();
        int[] temp = singlyLinkedList.nextGreaterNode();
        for (int t : temp)
            System.out.print(t + " ");*/
        //  singlyLinkedList.display();
        //System.out.println(singlyLinkedList.isPalindromeSLL());
        /*singlyLinkedList.createLinkedListHavingLoop();
        System.out.println(singlyLinkedList.containsLoopInSLL());
        System.out.println(singlyLinkedList.startNodeOfLoopInSLL().data);*/
        // singlyLinkedList.removeLoopInSLL();
        //singlyLinkedList.removeDuplicates();

      /*  singlyLinkedList.removeDuplicateFromSortedSLL();
        singlyLinkedList.display();
        singlyLinkedList.removeNodeBasedOnKey1(2);*/
        //   singlyLinkedList.removeNodeBasedOnKey1(3);
        //    singlyLinkedList.removeNodeBasedOnKey1(3);
        //   System.out.println(singlyLinkedList.isPalindrome());
        //   System.out.println(singlyLinkedList.nthNodeFromEndSecondApproach(6).data);
    ...
    public boolean containsLoopInSLL() {
    ...
    public ListNode startNodeOfLoopInSLL() {
        ListNode slowPtr = head;
        ListNode fastPtr = head;
        while (fastPtr != null && fastPtr.next != null) {
            slowPtr = slowPtr.next;
            fastPtr = fastPtr.next.next;
            if (slowPtr == fastPtr) {
                return startNodeInLoop(slowPtr);
            }
        }
        return fastPtr;
    }

    public ListNode startNodeInLoop(ListNode slowPtr) {
        ListNode temp = head;
        while (temp != slowPtr) {
            temp = temp.next;
            slowPtr = slowPtr.next;
    ...
    //m =2                 //n=4
    //[10|null]--[20|null]--[30|null]--[40|null]--[50|null] - null
    /*

     */
    //[10|null]--[40|null]--[30|null]--[20|null]--[50|null] - null


    public void reverseBetween(int m, int n) {
        if (m > lengthSinglyLinkedList() || n > lengthSinglyLinkedList())
            throw new IllegalArgumentException("length greater than SLL");
        ListNode first = head;
        int countA = 1;
        while (countA < m - 1) {
            countA++;
    ...
    public void reverseSLLInKPair(int k) {
        ListNode current = head;
    ...
    public void mergeSortedList(ListNode list1, ListNode list2) {
        ListNode dummy = new ListNode(0);
        ListNode a = list1;
        ListNode b = list2;
    ...
    public void reverseLogicForKPairs(ListNode current) {
        // ListNode current = head;
        ListNode previous = null;
        while (current != null) {
            ListNode temp = current.next;
    ...
    public void removeDuplicatesFromUnsortedSLL() {
        ListNode first = head;
        ListNode previous = first;
    ...
    public void removeDuplicateFromSortedSLL() {
        ListNode current = head;
        if (head == null)
            return;
        while (current != null && current.next != null) {
    ...
    public ListNode addNodeInSortedOrder(int value) {
        ListNode newNode = new ListNode(value);
        if (head == null)
            return newNode;
    ...
    //1//2 -->2 -->3 -->3 -->null
    // [2.5|null] = newNode
    public void removeNodeBasedOnKey1(int searchKey) {
        if (head == null)
            return;
    ...
    public ListNode nthNodeFromEndSecondApproach(int position) {
        if (head == null)
            return null;
        if (position < 1)
            throw new IllegalArgumentException("Invalid position " + position + ", less than 1 ");
        ListNode current = head;
        int count = 0;
        while (current != null) {
            count++;
        ...
        if (position > count)
            throw new IllegalArgumentException("Invalid position " + position + " greater than size of SLL");
        //count=5;
        current = head;
